...
def pydraw(X, U, X0, XN):
    ...
    start_point = shapes.Circle(100 + X0[0] * 10, 100 + X0[1] * 10, 3, color=(200, 40, 40), batch=batch)
    end_point   = shapes.Circle(100 + XN[0] * 10, 100 + XN[1] * 10, 3, color=(200, 40, 40), batch=batch)
    ...
    def on_draw():
        ...
        labelTheta.text = f"Theta:  {X[idx, 2]:.2f}"
        ...
        car.x = 100 + X[idx, 0] * 10
        car.y = 100 + X[idx, 1] * 10
        car.rotation = 90 - X[idx, 2] * 180 / np.pi
        car.draw()
